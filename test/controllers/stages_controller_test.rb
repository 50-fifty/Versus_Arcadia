...
class StagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stage" do
    assert_difference('Stage.count') do
      post stages_url, params: { stage: { description: @stage.description, name: @stage.name, nickname: @stage.nickname } }
    end
  ...
  test "should update stage" do
    patch stage_url(@stage), params: { stage: { description: @stage.description, name: @stage.name, nickname: @stage.nickname } }
